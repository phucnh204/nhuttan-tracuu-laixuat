        ...
        <div className="bg-white">
            <div className="p-10 max-w-6xl mx-auto    flex flex-col md:flex-row gap-10">
                ...
                <div className="md:w-1/2 space-y-6">
                    ...
                    <Paragraph className="text-yellow-600">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        {[
                            ...
                            <div
                                key={item.label}
                                className="flex flex-col items-center text-center p-3  rounded hover:shadow "
                            >
                                <img
                                    src={item.src}
                                    alt={item.label}
                                ...
                                />
                                <span className="font-medium text-yellow-300">{item.label}</span>
                            </div>
                        ))}
                    </div>
                    ...
                    >
                        ...
                        >
                            <Input
                                ...
                                className="w-full rounded-xl border-yellow-300 focus:border-yellow-500 focus:ring focus:ring-yellow-200 p-4 text-lg"
                            />
                        </Form.Item>
                        ...
                        >
                            <TextArea
                                placeholder="Ví dụ: Iphone 14 Plus 256GB màu xanh, Pin 80%, Mua ở thế giới di động còn hạn bảo hành đến 30/12/2025,..."
                                rows={6}
                                className="w-full rounded-xl border-yellow-300 focus:border-yellow-500 focus:ring focus:ring-yellow-200 p-4 text-lg resize-none"
                            />
                        </Form.Item>
